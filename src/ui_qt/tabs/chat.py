...
class ChatTab(QWidget):
    ...
    def __init__(self, parent: QWidget, window: "MainWindow") -> None:
        ...
        self.private_chat.stateChanged.connect(lambda _x: self.update_chat_target())
        ...
        self.chat_log.setAccessibleDescription(
            _("Lese-only Bereich. Strg+C kopiert markierten Text. "
        ...
        self.chat_input.setAccessibleDescription(
            _("Nachricht tippen und Enter drücken oder Senden klicken. "
