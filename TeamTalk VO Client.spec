...
a = Analysis(
    ...
    hiddenimports=['app_wx', 'teamtalk_client', 'teamtalk_client.tt', 'teamtalk_client.client', 'ui.tabs.system', 'ui_wx.tabs.system', 'platform_paths', 'sound_manager', 'objc', 'AppKit', 'Quartz', 'chat_history', 'global_hotkeys', 'pyaudio', 'i18n', 'mss', 'mss.tools', 'screen_capture', 'system_audio', 'qrcode', 'qrcode.image.pil', 'qrcode.image.base', 'PIL', 'PIL.Image', 'PIL.ImageDraw', 'PIL.ImageFont'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
...
app = BUNDLE(
    ...
    info_plist={
        'CFBundleShortVersionString': '7.5.10',
        'CFBundleVersion': '7.5.10',
