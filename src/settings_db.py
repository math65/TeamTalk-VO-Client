...
class SQLiteSettingsStore:
    ...
    def load(self) -> None:
        ...
        s.channel_password_index = _list("channel_password_index")
        ...
        s.app_audio_volume_pct = _int("app_audio_volume_pct", 100)
    ...
    def save(self) -> None:
        ...
        _set("channel_password_index", list(getattr(s, "channel_password_index", []) or []))
        ...
        _set("app_audio_volume_pct", int(getattr(s, "app_audio_volume_pct", 100) or 100))
